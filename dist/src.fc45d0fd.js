...
var App = function (_super) {
  ...
  App.prototype.compare = function (a, b) {
  ...
  App.prototype.toggleDone = function (index) {
    ...
    var tasks = tasks.sort(this.compare);
    this.setState({
      tasks: tasks
    });
  };
  ...
  App.prototype.renderTasks = function () {
    ...
    return this.state.tasks.map(function (task, index) {
      ...
      }, task.value), react_1.default.createElement("button", {
        onClick: function onClick() {
          return _this.deleteTask(task.id);
        }
      }, "Delete"), react_1.default.createElement("button", {
        onClick: function onClick() {
          return _this.toggleDone(index);
        }
  ...
  App.prototype.render = function () {
    ...
    return react_1.default.createElement(react_1.default.Fragment, null, react_1.default.createElement("h1", null, "Hello, ", this.props.name, ", your Todo List"), react_1.default.createElement("form", {
      ...
      type: "submit"
    }, "Add Task")), react_1.default.createElement("section", null, this.renderTasks()));
  };
...
},{"react":"node_modules/react/index.js","react-dom":"node_modules/react-dom/index.js","./components/App":"src/components/App.tsx","./styles/style.scss":"src/styles/style.scss"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
